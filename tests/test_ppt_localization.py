...
class TestPPTLocalization:
    ...
    def test_locale_passed_to_prompt_template(self, monkeypatch):
        ...
        monkeypatch.setattr(ppt_module, "get_prompt_template", mock_get_prompt_template)
        monkeypatch.setattr(ppt_module, "get_llm_by_type", mock_get_llm_by_type)

        # Create state with input and locale
        state = {"input": "hello", "locale": "zh-CN"}
