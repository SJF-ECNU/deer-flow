...
class TestInfoQuestSearchResults:
    ...
    def search_tool(self):
        ...
        def mock_run(query, **kwargs):
            ...
            return json.dumps(
                sample_cleaned_results, ensure_ascii=False
            ), sample_raw_results
    ...
    def test_init_default_values(self):
        ...
        with patch(
            "src.tools.infoquest_search.infoquest_search_results.InfoQuestAPIWrapper"
            ...
            with patch.object(
                InfoQuestSearchResults, "__init__", return_value=None
            ) as mock_init:
    ...
    def test_init_custom_values(self):
        ...
        with patch(
            ...
            with patch.object(
                ...
                InfoQuestSearchResults(
                    time_range=10, site="test.com", infoquest_api_key="dummy-key"
                )
